...
In contrast, $V_3$ is not parameterized, which indicates that the same citation is shared across all the view tuples. \scream{Maybe we don not need the figure, just point to SIGMOD paper}
