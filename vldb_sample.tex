...
This research was partially funded by NSF IIS 1302212 and NSF ACI 154736. The authors would like to thank Peter Buneman for conceiving the idea that data citation is a computational challenge and recognizing its connection to provenance, and to Val Tannen for discussions on query rewriting and provenance.
