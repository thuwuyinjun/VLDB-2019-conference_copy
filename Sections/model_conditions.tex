...
Let us revisit Example \ref{eg: conjunctive_case}. The instance of $Q_{\ref{eg: conjunctive_case}}'$ is shown in Table \ref{Table: Instance of Q1}. 
...
% % \end{tabular}
% % \small
% \caption{$Q_{\ref{eg: conjunctive_case}}'(D)$ with how-provenance}\label{Table: Instance of q9}
% \begin{tabular}[t]{c|c|c||b|} \hhline{~---}
% &T&Gid&prov\\ \hhline{~---}
% $t_{q_{\ref{eg: conjunctive_case}}'1}$&TEC&1&$g_1$\\ \hhline{~---}
% $t_{q_{\ref{eg: conjunctive_case}}'2}$&rRNA&2&$g_2$\\ \hhline{~---}
% $t_{q_{\ref{eg: conjunctive_case}}'3}$&rRNA&3&$g_3$\\ \hhline{~---}
% % $t_{q_{\ref{eg: conditions_conjunctive}}2}$&4&$a_4$&TEC&$c_4$&$T_4$\\ \hhline{~-------}
% \end{tabular}
% \end{table}

We can show that $M_{1\ref{eg: conjunctive_case}'}$ is a valid view mapping for the query tuple $t_{q_{\ref{eg: conjunctive_case}}'1}$ and $t_{q_{\ref{eg: conjunctive_case}}'2}$, as follows: The {\em schema-level conditions} are satisfied because 1) the head variable $Ty$ and $G$ in $V_1$ are mapped to the head variable $T$ and $Gid$ in $Q_{\ref{eg: conjunctive_case}}'$ respectively; % under $M_{\ref{eg: conditions_conjunctive}}'$; 
