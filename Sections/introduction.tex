...
\textbf{Approach.} Using provenance, we develop a citation system called ProvCite. The system executes over a provenance-enabled relational database system; here we are using GProM~\cite{arab2018gprom}.
